...
mod tests {
    ...
    use crate::integer;
    use crate::maingate;
    use ecc::halo2::ff::FromUniformBytes;
    use ecc::halo2::ff::WithSmallOrderMulGroup;
    use ecc::halo2::group::Curve;
    use ecc::halo2::group::Group;
